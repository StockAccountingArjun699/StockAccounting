...
public static Object mouseClick;
WebDriver driver;
//startBrowser
	...
	public static WebDriver startBrowser(WebDriver driver) throws Throwable
	{
		...
		if(PropertyFileUtil.getValueForKey("Browser").equalsIgnoreCase("firefox"))
		{
			...
			{
				System.setProperty("webdriver.chrome.driver","C:\\Users\\nagarjuna.y\\workspace\\StockAccounting\\MavenStockAccounting\\ExecutableFiles\\chromedriver.ex");
						driver=new ChromeDriver();
			}else
				if(PropertyFileUtil.getValueForKey("Browser").equalsIgnoreCase("ie"))
				{
					System.setProperty("webdriver.chrome.driver","C:\\Users\\nagarjuna.y\\workspace\\StockAccounting\\MavenStockAccounting\\ExecutableFiles\\IEDriverServer.exe");
	...
	public static void captureData(WebDriver driver,String locatorType,String locatorValue) throws IOException
	{
		...
		FileWriter fw=new FileWriter("C:\\Users\\nagarjuna.y\\workspace\\StockAccounting\\MavenStockAccounting\\CaptureData\\Data.txt");
	...
	public static void tableValidation(WebDriver driver,String column) throws Throwable
	{
		...
		//row count
		 ...
		 for (int i =1; i <=rows.size(); i++)
		 {
			 ...
			 String act_Data=driver.findElement(By.xpath("//*[@id='ewContentColumn']/div[3]/form/div//table[@id='tbl_a_supplierslist']/tr["+i+"]/td["+colNum+"]/div/span")).getText();
